...
<head>
  ...
  <script type="text/javascript">
     var _root = "<?php echo $root ?>";
	   ...
	   var uploadServerPath = "<?php  echo $uploadServerPathFromRoot; ?>";	
  </script>
     ...
     <header class ="container-fluid">
      ...
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <img src="images/sky.png" alt="Sky" class="full-image">
          
          <div class="inTheatresCont"> 
            <img src ="images/inTheatres.png" alt="In theatres" class="inTheatresLocation" id="inTheatresLocation">
          </div>

           <div class="headerCtaCont">  
            <div class="headerCtaText" id="headerCtaText" style="display:none;">For International Release</div>
            <div class="headerCtaBtn" id="headerCtaBtn" style="display:none;">click here</div>
          </div>
          ...
          <div class="redBtnCont">
            ...
            <a href="https://www.facebook.com/RickiAndTheFlash" target="_blank" id="outerFb"><img src="images/icon_fb.png" alt="facebook icon" class="icon_fb"></a>
      ...
      <footer class ="container-fluid">
        ...
        <div class="row footerBg">
          ...
          <div class="col-xs-12 no-padding" >
             ...
             <img src="images/footer_bg.png" alt="Fotter background asphalt" class="full-image">
              ...
              <div class="flagsCont">
               ...
               <div class="ratingCont">
                 <img src="images/rating_en.png" alt="Movie rating icon." class="ratingImg">
             </div>
          ...
          <script type="text/javascript" src="http://sonypictures.com//global/scripts/s_code.js"></script>
          <script type="text/javascript"> 
          s.pageName="us:movies:rickiandtheflash:momswhorock:index.html";
          s.channel=s.eVar3="us:movies";
          s.prop3=s.eVar23="us:movies:rickiandtheflash:momswhorock";
          s.prop4=s.eVar4="us:rickiandtheflash";
          s.prop5=s.eVar5="us:movies:microsite";
          s.prop11="us";
