      ...
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <div class="inTheatresCont"> 
            <img src ="../images/inTheatres_german.png" alt="In theatres" class="inTheatresLocation" id="inTheatresLocation">
          </div>
          ...
          <div class="redBtnCont">
            ...
            <a href="https://www.facebook.com/RickiMovie" target="_blank" id="outerFb" style="display:none;"><img src="../images/icon_fb.png" alt="facebook icon" class="icon_fb"></a>
