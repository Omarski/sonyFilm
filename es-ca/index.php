 ...
 <!--  cardmaker -->
  ...
  <body>
     ...
     <header class ="container-fluid">
        ...
        <div class="row" id="mexRow">
        <div class="col-xs-12 no-padding">

          <div id="cookies_container" style="top: 0px;">
            <div id="sp-nettrack" class="cookieTextCont"><p>Este sitio utiliza cookies de terceros para mejorar los servicios y mostrar publicidad relacionada con sus preferencias mediante el análisis de sus hábitos de navegación. Al continuar navegando, consideramos que aceptas su uso. Puedes obtener más información o cambiar la configuración en nuestra<a id="cookie-click" href="http://www.sites.sonypicturesreleasing.es/legal.php" target="_blank">&nbsp;Política de Cookies</a></p>.<img id="sp-nettrack-button" class="acceptcookies_button" src="../images/acceptBtnEs.png"></div></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <div class="inTheatresCont"> 
            <img src ="../images/inTheatres_castilianSpanish.png" alt="In theatres" class="inTheatresLocation" id="inTheatresLocation">
          </div>
          ...
          <div class="redBtnCont">
            ...
            <a href="https://www.facebook.com/RickiMovie" target="_blank" id="outerFb"><img src="../images/icon_fb.png" alt="facebook icon" class="icon_fb"></a>
        ...
        <div class="row footerBg">
          ...
          <div class="col-xs-12 no-padding" >
             ...
             <div class="ratingCont">
                 <img src="../images/rating_en.png" alt="rating icon" class="ratingImg">
             </div>
