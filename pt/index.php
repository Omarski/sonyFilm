      ...
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <div class="inTheatresCont"> 
            <img src ="../images/inTheatres_portuguese.png" alt="In theatres" class="inTheatresLocation" id="inTheatresLocation">
          </div>
      ...
      <footer class ="container-fluid">
        ...
        <div class="row footerBg">
          ...
          <div class="col-xs-12 no-padding" >
             ...
             <img src="../images/footer_bg.png" alt="background asphalt" class="full-image">
