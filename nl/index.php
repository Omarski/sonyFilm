      ...
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <div class="inTheatresCont"> 
            <img src ="../images/inTheatres_dutch.png" alt="In Theatres" class="inTheatresLocation" id="inTheatresLocation">
          </div>
          ...
          <div class="redBtnCont">
            ...
            <img src="../images/icon_audio_on.png" class="icon_audio" alt="audio icon" id="audioIcon">
          </div>
