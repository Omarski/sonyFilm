...
<!--[if gt IE 8]><!--> <html class="no-js"  lang="es-la">  <!--<![endif]-->
       ...
       <div class="row" id="mexRow">
        <div class="col-xs-12 no-padding">
          ...
          <div id="cookies_container" style="top: 0px;">
            <div id="sp-nettrack" class="cookieTextCont"><p>Este sitio web utiliza cookies para mejorar su funcionalidad y desempeño. Al usar este sitio, estás de acuerdo con la colocación de estas Cookies y con nuestra Política de <a id="cookie-click" href="http://www.sonypictures.com.mx/Sony/Politics.SonyPictures;jsessionid=482D35E653954E132986FD33A55ED814?business=2" target="_blank">Cookies.</a></p><img id="sp-nettrack-button" class="acceptcookies_button" src="../images/acceptBtn.png"></div></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <div class="inTheatresCont"> 
            <img src ="../images/inTheatres_latamSpanish.png" alt="In theatres" class="inTheatresLocation" id="inTheatresLocation">
          </div>
