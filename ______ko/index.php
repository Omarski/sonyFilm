     ...
     <header class ="container-fluid">
      <div class="row">
        <div class="col-xs-12 no-padding">
          ...
          <img src="../images/sky.png" id="skyNLogo" class="full-image">
          
          <div class="inTheatresCont"> 
            <img src ="../images/inTheatres_korean.png" class="inTheatresLocation" id="inTheatresLocation">
           <!--  <div class="inTheatresLocation" id="inTheatresLocation">In U.S. Theaters</div>
            <div class="inTheatresDate" id="inTheatresDate">THIS AUGUST</div> -->
          </div>
          ...
          <div class="redBtnCont">
            ...
            <a href="https://www.facebook.com/RickiMovie" target="_blank" id="outerFb"><img src="../images/icon_fb.png" class="icon_fb"></a>
            <a href="http://www.twitter.com/RickiMovie" target="_blank" id="outerTw"><img src="../images/icon_twitter.png" class="icon_twitter"></a>
            <img src="../images/icon_audio_on.png" class="icon_audio" id="audioIcon">
          </div>
      ...
      <footer class ="container-fluid">
        ...
        <div class="row footerBg">
          ...
          <div class="col-xs-12 no-padding" >
             ...
             <img src="../images/footer_bg.png" class="full-image">

             <div class="ratingCont">
                 <img src="../images/rating_en.png" class="ratingImg">
             </div>

              <div class="flagsCont">
                <img src="../images/icon_fl_am.png" class="icon_fl_am">
                <img src="../images/icon_fl_fr.png" class="icon_fl_fr">
                <img src="../images/icon_fl_ge.png" class="icon_fl_de">
                <img src="../images/icon_fl_it.png" class="icon_fl_it">
                <img src="../images/icon_fl_ja.png" class="icon_fl_jp">
                <img src="../images/icon_fl_ko.png" class="icon_fl_ko">

                <img src="../images/icon_fl_me.png" class="icon_fl_es-la">
                <img src="../images/icon_fl_po.png" class="icon_fl_pt">
                <img src="../images/icon_fl_sp.png" class="icon_fl_es-ca">
                <img src="../images/icon_fl_ho.png" class="icon_fl_nl">
                <img src="../images/icon_fl_au.png" class="icon_fl_au">
                <img src="../images/icon_fl_sw.png" class="icon_fl_sv">
                <img src="../images/icon_fl_br.png" class="icon_fl_br">
              </div>
